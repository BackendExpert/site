...
import reactJkcssImage from "../../../assets/ReactJKCSS.png"; 

const Hero = ({
    productName = "ReactJKCSS",
    tagline = "First-class React bindings for JKCSS",
    description = "A React-focused extension of JKCSS that enables dynamic, component-based front-end development while preserving clean, utility-first styling.",
    docsLink = "",
    githubLink = "https://github.com/react-jkcss",
}) => {
    return (
