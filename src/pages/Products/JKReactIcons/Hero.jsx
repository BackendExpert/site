...
const Hero = ({
    ...
    tagline = "Dynamic, easy-to-use icon library for React projects",
    description = "JKReact Icons is a lightweight, production-ready React icon library developed by BlackAlphaLabs, offering a wide range of customizable and scalable icons for modern web applications.",
    docsLink = "",
    githubLink = "https://github.com/jkreact-icons",
}) => {
    return (
              ...
              hover:border-gray-400 hover:text-gray-900 transition"
                ...
                <div className="relative flex justify-center lg:justify-end">
                    <div className="relative rounded-3xl border border-gray-200 bg-white shadow-xl p-4">
                        <img
                            src={jkreactIconsImage}
                            alt="JKReact Icons Preview"
